...
func NewHTTPHandler() http.Handler {
	...
	//edit activity
	router.HandleFunc("/editActivity", handlers.UpdateActivity).Methods("POST")
	//assign employees
	...
	router.HandleFunc("/getDiariesOrders/{companyId}/{date}", handlers.GetDiariesOrders).Methods("GET")
